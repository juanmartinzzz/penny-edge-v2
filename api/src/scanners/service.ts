  ...
  try {
    ...
    await upsertWarmSymbols(
      ...
      matchedQuotes.map((quote) => ({
        ...
        volume: quote.volume,
        volumeQuote: volumeQuote(quote),
        avgVolume10d: quote.averageVolume10d ?? null,
        avgVolume10dQuote: avgVolume10dQuote(quote),
...
function serializeWarmSymbol(
  ...
  return {
    ...
    volume: row.volume,
    volumeQuote: row.volume_quote ?? null,
    avgVolume10d: row.avg_volume_10d,
    avgVolume10dQuote: row.avg_volume_10d_quote ?? null,
